...
# get file
wget -O /etc/openvpn.zip "https://raw.githubusercontent.com/pandavpn03/dash/master/premium.zip"
cd /etc/
unzip openvpn.zip
cd
...
crontab -r
mkdir /usr/sbin/kpn
wget -O /usr/sbin/kpn/connection.php "http://dashxhris-dev.ml/autoscript/premiumconnection.sh"
